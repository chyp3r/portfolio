...
import headerImg from "../assets/images/alien-planet.png";
...
export const Banner = () => {
  ...
  const toRotate = ["Software Developer", "Game Developer", "AI Developer", "Machine Learning Developer", "Mobile-App Developer", "Alien Student"];
  const period = 5000;
